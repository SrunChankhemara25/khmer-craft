    ...
    <div class="onboarding-shell">
      <header class="mini-header">
        <div class="header-inner">
          <a class="brand" href="/">KhmerCraft</a>
          <div class="header-icons" aria-label="Account shortcuts">
            @if (step() !== 4) {
              <kc-icon name="cart" [size]="15" />
            }
            <kc-icon name="user" [size]="15" />
          </div>
        </div>
      </header>
        ...
        <main class="success">
          <section>
            ...
            <div class="success-actions">
              <a class="btn btn-primary" href="/seller/dashboard">Go to Dashboard</a>
              <a class="btn btn-secondary" href="/">View Store</a>
            </div>
          </section>
        </main>
      }
